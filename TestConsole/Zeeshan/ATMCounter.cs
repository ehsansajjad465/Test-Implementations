...
namespace TestConsole.Zeeshan
{
    public class ATMCounter
    {
        ...
        public class ATMCounterResponse
        {
            public string recepientName { get; set; }
            public List<AttributeList> attributeLists { get; set; }
        }
        public class AttributeList
        {
            public string formLabel { get; set; }
            public string recycleMachineType { get; set; }
            public List<recieptLabels> recieptLabels { get; set; }
        }
        public class recieptLabels
        {
